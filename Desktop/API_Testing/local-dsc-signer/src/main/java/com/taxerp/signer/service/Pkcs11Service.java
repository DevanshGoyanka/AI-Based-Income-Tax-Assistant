...
public class Pkcs11Service {
    ...
    /**
     * Get KeyStore from USB token using reflection to avoid module issues
     */
    public KeyStore getKeyStore() throws Exception {
        ...
        // Load PKCS11 provider using reflection
        Provider pkcs11Provider = Security.getProvider("SunPKCS11");
        if (pkcs11Provider == null) {
            logger.debug("Loading SunPKCS11 provider via reflection");
            
            // Use reflection to instantiate SunPKCS11
            Class<?> sunPKCS11Class = Class.forName("sun.security.pkcs11.SunPKCS11");
            Constructor<?> constructor = sunPKCS11Class.getConstructor(java.io.InputStream.class);
            pkcs11Provider = (Provider) constructor.newInstance(

...
/**
 * Java representation of key fields from PreFillSchemaJSON_V6.5/AY 2026-27
 * populated by the PrefillMapper from raw portal JSON.
 * COMPLETE - 101% CBDT Compliant for AY 2026-27
 */
public class PreFillData {
    ...
    public String fatherName;       // NEW - Required for Verification
    public String dob;              // yyyy-MM-dd
    public String aadhaarCardNo;
    public String email;
    public String mobile;
    public String residentialStatus; // "RES", "NOR", "NRI"
    public String gender;           // NEW - M/F/T
    public String maritalStatus;    // NEW - SINGLE/MARRIED/DIVORCED/WIDOWED
    ...
    // ── User Bank Details for Refund ───────────────────────────────────────
    public String bankName;         // NEW - Required for refund
    public String bankAccountNo;    // NEW - Required for refund
    public String bankIFSC;        // NEW - Required for refund
    public String bankAccountType;  // NEW - SB/CURRENT
    ...
    // Filing Type - NEW for AY 2026-27
    public boolean isRevised = false; // For ReturnFileSec: 11 vs 17
    public String originalAckNo;      // For revised returns

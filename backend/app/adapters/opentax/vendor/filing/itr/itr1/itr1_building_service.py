...
from ...utils.tax_filing_helpers import compute_age
from ...utils.master_data_service import MasterDataService

from ...itr.itr1.models.filing_build_itr1_return_model import FilingBuildItr1ReturnModel
...
from ...itr.models.income_only_result import IncomeOnlyResult
from ...tax_calculation.models.tax_regime_breakdown import TaxRegimeBreakdownModel
from ...itr.itr1.itr1_income_builder_service import Itr1IncomeBuilderService
from ...itr.itr1.itr1_deduction_builder_service import Itr1DeductionBuilderService, Itr1ComputationContext
from ...itr.validations.tax_validation_service import TaxValidationService
from ...tax_calculation.interest_234_service import Interest234Service, parse_date
...
class Itr1BuildingService:
    ...
    async def build_personal_info(self, filing: FilingModel, personal_info: PersonalInfoModel) -> PersonalInfoModel:
        """Build PersonalInfo: set all fields from ..."""
    ...
    def build_refund(self, filing: FilingModel) -> RefundModel:
        """Build Refund section: use passed refund if any, set RefundDue and BankAccountDtls from ..."""
    ...
    def build_verification(self, filing: FilingModel, verification: VerificationModel) -> VerificationModel:
        """Build Verification section: use passed verification if any, set Declaration/Capacity/Place from ..."""
        from ...itr.itr1.models.itr1_model import DeclarationModel

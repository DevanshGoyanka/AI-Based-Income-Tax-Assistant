...
from ..itr.models.filing_build_itr_return_model import FilingBuildItrReturnModel
...
from ..itr.itr1.itr1_building_service import Itr1BuildingService
from ..tax_calculation.tax_calculation_service import TaxCalculationService
...
class ItrBuildingOrchestrator:
    ...
    def _build_schedule_tcs_itr1(self, filing: FilingModel) -> ScheduleTCSModel | None:
        """Build ITR1 ScheduleTCS from ..tcs."""
        if not filing.tcs:
            return None
    ...
    def _build_schedule_tcs_itr2(self, filing: FilingModel) -> Any | None:
        """Build ITR2 ScheduleTCS from ..tcs using the ITR2 schema shape."""
        if not filing.tcs:
            return None

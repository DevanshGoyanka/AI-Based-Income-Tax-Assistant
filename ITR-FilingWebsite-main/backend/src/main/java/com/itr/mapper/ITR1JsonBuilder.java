...
public class ITR1JsonBuilder {
    ...
    private static final String ASSESSMENT_YEAR = "2026-27";
    ...
    private ObjectNode verification(PreFillData p) {
        ...
        decl.put("AssesseeVerName", (p.firstName + " " + (p.middleName != null && !p.middleName.isEmpty() ? p.middleName + " " : "") + p.lastName).trim());
        decl.put("FatherName",      "");
        decl.put("Capacity",        "S");

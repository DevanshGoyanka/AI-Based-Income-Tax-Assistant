...
public class ITRFilingOrchestrationService {
    ...
    @Autowired private ITR1CBDTValidationService itr1Validator;
    ...
    @Autowired private ITDJSONExportService jsonExporter;
    ...
    public FilingResult processITR3(Itr3FormData data) {
        ...
        // CBDT Validation
        ITR3CBDTValidationService.ValidationResult validation = itr3Validator.validate(data);
        result.setValidationErrors(validation.getErrors());
        result.setValidationWarnings(validation.getWarnings());
    ...
    public FilingResult processITR4(Itr4FormData data) {
        ...
        ITR4CBDTValidationService.ValidationResult validation = itr4Validator.validate(data);
        result.setValidationErrors(validation.getErrors());
        result.setValidationWarnings(validation.getWarnings());
    ...
    public FilingResult processITR1(Itr1FormData data) {
        ...
        ITR1CBDTValidationService.ValidationResult validation = itr1Validator.validateITR1(data);
        result.setValidationErrors(validation.getErrors());
        result.setValidationWarnings(validation.getWarnings());
